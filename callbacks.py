...
def get_redweb_callbacks(model, basemodel, train_generator, test_generator, test_set, runPath):
    callbacks = []
...
def get_diml_callbacks(model, basemodel, train_generator, test_generator, test_set, runPath):
    callbacks = []
...
def get_megadepth_callbacks(model, basemodel, train_generator, test_generator, test_set, runPath):
    callbacks = []
